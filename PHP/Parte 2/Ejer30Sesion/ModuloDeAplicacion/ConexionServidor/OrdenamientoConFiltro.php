        ...
        if($Estado_de_respuesta=="Conexion Exitosa Con Base De Datos")
        {
            ...
            try
            {
                $stmt=$dbh->prepare($sql);
                 $Estado_de_respuesta= "PREPARACION de Sentencia de FILTRO Y ORDENAMIENTO realizada con EXITO";
                ...
                $Estado_de_respuesta= "BINDING de Variables en FILTRO Y ORDENAMIENTO realizada con EXITO";
                GuardarEnArchivologsExitosos($Estado_de_respuesta);
                ...
                $stmt->execute();
                $Estado_de_respuesta=  "EJECUCION de consulta sql de FILTRO Y ORDENAMIENTO realizada con EXITO";
